                    ...
                    <div className="space-y-2.5 pl-6">
                        {categories.map((cat) => (
                            <label key={cat} className="flex items-center gap-3 cursor-pointer group">
                                ...
                                />
                                <div className={`w-4 h-4 rounded border-2 flex items-center justify-center transition-colors group-hover:border-primary`}>
                                    {/* Checkbox visual akan dihandle CSS atau bisa ditambahkan logic visual jika perlu */}
                                </div>
                    ...
                    <div className="space-y-2.5 pl-6">
                        {prices.map((price) => (
                            <label key={price} className="flex items-center gap-3 cursor-pointer group">
                                ...
                                />
                                <div className="w-4 h-4 rounded-full border-2 border-gray-300 flex items-center justify-center transition-colors group-hover:border-primary">
                                </div>
                                <span className="text-sm text-gray-600 group-hover:text-gray-900 transition-colors">
                                    {price}
                                </span>
